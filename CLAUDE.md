...
| `プロジェクト機能仕様` `業務フロー機能仕様` `業務フロー仕様` `ビジネスフロー仕様` `business flow function spec` `機能仕様書 生成` `続きから 機能仕様` `resume function spec` | `.claude/skills/einja-project-function-spec/SKILL.md` |
