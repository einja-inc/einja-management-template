...
**良い例**:
```markdown
- [ ] **AC1.UI.N.001**: 有効なメールアドレスで送信すると、成功メッセージが表示されメールが送信される
...
- **AC番号体系**: `AC{Story#}.{Cat}.{N|E}.{連番3桁}` 形式（例: `AC1.UI.N.001`, `AC1.VAL.E.001`）。カテゴリは UI/NAV/VAL/ERR/PERM/UX、区分は N=正常系/E=異常系
