# create-einja-app ビルドプロセス

## 概要

create-einja-appのビルドは2段階で実行されます：
...
- `packages/cli/`, `packages/create-einja-app/` - CLIパッケージ本体
- `.claude/agents/einja/`, `.claude/commands/einja/` 等 - @einja/cli管轄
