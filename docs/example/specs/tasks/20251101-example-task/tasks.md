...
**要件**: Story 1, Story 2
**依存関係**: 1.1.3, 1.2.2
**完了条件**: フェーズ1の全タスクグループが完了し、受け入れ基準**AC1.1-AC1.3、AC2.1-AC2.2**を満たすことが確認できること
**次フェーズ移行基準**:
- 認証機能が正常に動作し、Magic Link送信・検証ができること
- プロフィール管理機能が正常に動作し、取得・更新ができること
- 全E2Eテストが成功すること
- Biomeエラー0件を維持していること
- データベースマイグレーションが正常に完了していること
...
**要件**: Story 1
**依存関係**: 2.1.1
**完了条件**: フェーズ2の全タスクグループが完了し、受け入れ基準**AC1.4**を満たすことが確認できること
**次フェーズ移行基準**:
- 認証UIが正常に動作し、ユーザーがログインできること
